...
**For specific marketing contexts:**

- **Landing Pages**: See [references/landing-pages.md](references/landing-pages.md)
- **Email Campaigns**: See [references/email-sequences.md](references/email-sequences.md)
- **Social Media**: See [references/social-templates.md](references/social-templates.md)
- **Competitive Positioning**: See [references/battle-cards.md](references/battle-cards.md)
- **Brand Voice Rules**: See [references/brand-voice.md](references/brand-voice.md)

---

## The Four Pillars Framework

Every piece of marketing copy must anchor to at least one of these pillars:

### 1. The Revenue Pillar ("See Your Sales")
...
- "Know if your ad sold anything. In Naira."
- "See your sales — not just clicks"
- "Track every WhatsApp message that clicked your ad"
- "Your ₦10,000 ad. Here's what it earned."
...
- "Pay in Naira, not dollars"
- "Paystack-powered. No international card needed"
- "Prepaid access, not recurring USD traps"
...
- "Studio-quality ads from phone photos"
- "No designer needed. No expensive agency"
- "Instant redesign with AI"
...
- "Chat to launch. No expert needed"
- "2-minute ad setup"
- "AI handles the technicality, you handle business"
...
**Core Personality:** A smart, trusted friend who knows how to run ads for Nigerian businesses. Speaks in plain terms. Celebrates the hustle.
...
| Optimize | Improve |
| Optimize for conversions | Help you get more sales |
| WhatsApp clicks | People who messaged |
| Website clicks | People who visited |
| Revenue | Sales / Money made |
| Recurring billing | Membership / Prepaid access |
| Bot | AI / Assistant |
| Dollars ($) | Naira (₦) |
| Enterprise | — (never use) |
| Landing page | Link / Page |

**Style:**

- Direct & action-oriented (short sentences)
- Localized professionalism (acknowledge local context without being condescending)
- Speed & relief focused ("Now", "Instant", "Finally", "That's it")
- Celebrate the win, not the tool ("You made ₦45,000 from that ad.")
...
| Revenue Tracking | None                          | ₦ ROI per ad                |
| Integration      | Generic                       | WhatsApp-native             |
| Support          | Email tickets                 | Local support               |

**Key Attack Points:**

- Payment reliability ("Your card works here")
- Revenue visibility ("See if your ad actually sold")
- Mobile optimization ("Built for your phone")
...
| Transparency     | Black box               | You see everything |
| Revenue Tracking | "We got you 200 clicks" | "You made ₦45,000" |
| Revisions        | Extra charges           | Unlimited          |

**Key Attack Points:**

- Cost efficiency ("10x cheaper")
- Speed ("Launch today, not next week")
- Revenue ownership ("Know what sold, not just what was clicked")
...
| Revenue Reporting | None (shows clicks) | ₦ sales from each ad              |
| Creative          | Upload-only         | AI generation                     |
| Language          | CTR, CPM, ROAS      | People reached, sales, money made |
...
- **Channel:** Landing page, email, social, pitch deck?
- **Audience:** First-time visitor, active user, churned user, investor?
- **Goal:** Awareness, conversion, retention, fundraising?

### Step 2: Select Primary Pillar

- Revenue (for audience who can't tell if their ads are working)
- Payment (for audience struggling with international tools)
- Creative (for audience needing design help)
- Simplicity (for audience intimidated by Meta Ads Manager)
...
- [ ] Differentiates from a specific competitor if that was the goal
- [ ] Includes a clear, simple CTA
- [ ] Passes anti-scam filter
...
```
[Bad]: "The best ad tool for Africa"
[Bad]: "AI-powered ad management for SMEs"
[Good]: "Turn Your ₦10,000 Ad Into Real Sales. Pay in Naira. No Expert Needed."
```

### Feature Benefit (Product Page)

```
[Bad]: "Track your campaign attribution metrics"
[Good]: "See Exactly How Many People Messaged You From Your Ad. And How Much You Made."
```

### Revenue Tracking Pitch
...
```
[Bad]: "Limited time offer - 50% off"
[Good]: "Your competitors launched 3 ads this week. Yours takes 2 minutes."
```
...
```
[Bad]: "Your campaign has 200 clicks"
[Good]: "Your ad reached 4,200 people. 47 messaged. You recorded 3 sales. 🎉"
```
...
### The "Blind Spend" Pattern

**Use Case:** Targeting SMEs who currently run ads but have no idea if they're working.
...
**Use Case:** Re-engaging users who bounced due to payment failures on competitor platforms.
...
**Use Case:** Converting users currently using expensive agencies.
...
**Use Case:** Converting DIY users frustrated with Ads Manager.
