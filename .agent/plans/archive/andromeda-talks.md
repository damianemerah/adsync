At API level, “Creative testing” after Andromeda is just **structured ways of serving multiple creatives under controlled rules** so the algorithm doesn’t starve similar variants. There are three main mechanisms you can use from Tenzu.
...
For Tenzu, this means: generate 2–5 distinct creatives for the same targeting, attach them as separate ads under one ad set, and mark that ad set as being in test mode.
...
This is how you’d implement **true creative testing** in Tenzu for more serious budgets.
...
# 5. Tenzu architecture that fits Andromeda
...
# 8. The real opportunity for Tenzu

Tenzu advantage is here:
...
Tenzu becomes **far more powerful than Ads Manager for SMEs**.
...
If you want, I can also show **the Meta internal “creative testing ladder” used by top ad buyers**, which would fit perfectly into **Tenzu Phase 2B Creative Intelligence**. It's extremely effective for WhatsApp businesses.
