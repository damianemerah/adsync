...
export const TIER_CONFIG = {
  starter: {
    ai: {
      ...
      premiumImageModel: "fal-ai/nano-banana-pro" as const,
      useSkills: true,
      maxCopyVariations: 5,
    ...
    limits: {
      ...
      maxAdAccounts: 999,
      maxTeamMembers: 999,
      linkAnalyticsDays: 36500,
      customLinkSlugs: true,
      maxMonthlyChats: 2000,
      adSpendCeilingKobo: 10_000_000,  // ₦100,000 — drives auto-upgrade to Growth
  ...
  growth: {
    ...
    limits: {
      ...
      customLinkSlugs: true,
      maxMonthlyChats: 2000,
      adSpendCeilingKobo: 30_000_000,  // ₦300,000 — drives auto-upgrade to Agency
...
export const BILLING_PLANS = [
  {
    ...
    tagline: "For businesses spending up to ₦100K/mo on ads",
    features: [
  ...
  },
  {
    ...
    tagline: "For businesses spending ₦100K–₦300K/mo on ads",
    features: [
      `${PLAN_CREDITS.growth} AI credits / month`,
      "All features included",
      "Unlimited Ad Accounts & Businesses",
      "AI Copy (Free) + Pro Image Generation",
      "Advanced Analytics + Credit Rollover",
      "Buy more credits anytime",
    ],
    highlight: true,
  },
  {
    ...
    tagline: "For businesses spending above ₦300K/mo on ads",
    features: [
