...
function mapStateToDb(state: Partial<CampaignState>) {
  ...
  return {
    ...
    targeting_snapshot: {
      ...
      life_events: targetLifeEvents || [],
      work_positions: targetWorkPositions || [],
      industries: targetIndustries || [],
      languages: targetLanguages || [],
      exclusion_audience_ids: exclusionAudienceIds || [],
      locations: locations || [],
...
function mapDbToState(campaign: CampaignRow): Partial<CampaignState> {
  ...
  return {
    ...
    targetLifeEvents: targeting.life_events || [],
    targetWorkPositions: targeting.work_positions || [],
    targetIndustries: targeting.industries || [],
    targetLanguages: targeting.languages || [],
    exclusionAudienceIds: targeting.exclusion_audience_ids || [],
